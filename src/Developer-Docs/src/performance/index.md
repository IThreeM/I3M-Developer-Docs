...
So how does I3M solve the problem of unique mutable access? It forces you to use a "top-down" flow in your game.
...
generational arenas (_pool_ in I3M's terminology) and handles. Instead of storing the objects in various places,
