...
parameter of a particle. You can tweak the seed of current random number generator (`i3m::core::thread_rng()`) to
...
[API docs](https://docs.rs/i3m/latest/i3m/scene/particle_system/index.html) for particle system for more information. 
...
I3M used special technique, called soft particles, that smooths sharp transitions between particles and scene geometry: 
