...
fn create_stack_panel(ctx: &mut BuildContext) -> i3m::core::pool::Handle<UiNode> {
...
fn create_horizontal_stack_panel(ctx: &mut BuildContext) -> i3m::core::pool::Handle<UiNode> {
    StackPanelBuilder::new(
        WidgetBuilder::new()
            .with_child(
                TextBuilder::new(WidgetBuilder::new())
