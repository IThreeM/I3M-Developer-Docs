use i3m::core::color::{Color, Hsv};
use i3m::core::{ComponentProvider, TypeUuidProvider};
use i3m::gui::border::BorderBuilder;
use i3m::gui::brush::Brush;
use i3m::gui::message::MessageDirection;
use i3m::gui::text::TextBuilder;
use i3m::gui::widget::{WidgetBuilder, WidgetMessage};
use i3m::gui::{
