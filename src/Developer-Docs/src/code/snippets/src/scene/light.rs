use i3m::core::algebra::{UnitQuaternion, Vector3};
use i3m::scene::light::point::PointLightBuilder;
use i3m::scene::light::spot::SpotLightBuilder;
use i3m::scene::light::BaseLight;
