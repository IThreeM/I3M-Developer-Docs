...
use i3m::core::algebra::{Matrix4, Point3, Vector2, Vector3};
use i3m::core::futures::executor::block_on;
use i3m::core::math::ray::Ray;
use i3m::core::math::{TriangleDefinition, Vector3Ext};
use i3m::core::pool::Handle;
use i3m::renderer::Renderer;
use i3m::resource::texture::{Texture, TextureWrapMode};
use i3m::scene::base::BaseBuilder;
use i3m::scene::camera::{
...
use i3m::scene::mesh::buffer::{VertexAttributeUsage, VertexReadTrait};
use i3m::scene::mesh::surface::SurfaceData;
use i3m::scene::mesh::Mesh;
...
async fn create_skybox(resource_manager: ResourceManager) -> SkyBox {
    ...
    let (front, back, left, right, top, bottom) = i3m::core::futures::join!(
